...
sealed class UserGroupSyncItem : ISyncItem<UserGroupKind, UserGroupDto>
{
    ...
    public UserGroupKind? LocalMerged { get; set; }
    public UserGroupDto? Remote
    {
        get;
        set
        {
    ...
    public UserGroupDto? RemoteMerged { get; set; }
...
internal static class UserGroupSyncItemExtensions
{
    extension(UserGroupSyncItem Item)
    {
